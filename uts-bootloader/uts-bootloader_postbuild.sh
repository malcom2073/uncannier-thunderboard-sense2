...
echo " "
"${COMMANDER}" convert "/opt/SimplicityStudio_v4/developer/sdks/gecko_sdk_suite/v2.6/platform/bootloader/build/first_stage/gcc/first_stage_btl_efx32xg12.s37" "${FILENAME}.s37" -o "${FILENAME}-combined.s37"
